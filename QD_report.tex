...
\begin{figure}
\includegraphics[width=1\linewidth]{Simulations//learHonest_//QualStDv_//weightsVarQualSt} \caption{\label{fig:honest_learn}Actor and critic developed when signals are honest. Left panel: honest signal. Right panel: learners behavioral response }\label{fig:fig9}
\end{figure}
