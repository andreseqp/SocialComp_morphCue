...
\usepackage{float} \usepackage{multicol} \usepackage{amsmath} \usepackage{graphicx} \usepackage{array} \usepackage{xcolor} \usepackage{makecell}
\ifLuaTeX
...
\begin{center}\includegraphics[width=0.4\linewidth]{../Images/sexSelec} \includegraphics[width=0.4\linewidth]{../Images/dominance2} \end{center}
\end{block}
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth]{../Images/houseSparrows} \end{center}
\end{block}
\end{frame}
...
\begin{center}\includegraphics[height=0.45\textheight]{../Images/Amotz_Zahavi_profile} \includegraphics[height=0.45\textheight]{../Images/sexualSelection} \includegraphics[height=0.45\textheight]{../Images/Grafen} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-14-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{../Simulations/alphaAct_/alphaAct0.4learnDyn} \end{center}
\end{frame}
...
\includegraphics[width=0.45\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-16-2}
\end{block}
\end{frame}
...
\includegraphics[width=0.9\linewidth]{../Simulations/initAct_/indVarScatter01_}
\end{block}
\end{frame}
...
\includegraphics[width=0.9\linewidth]{../Simulations/initAct_/indVarScatter11_}
\end{block}
\end{frame}
