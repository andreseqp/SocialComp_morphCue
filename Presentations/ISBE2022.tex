...
\begin{center}\includegraphics[width=0.5\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{ISBE2022_files/figure-beamer/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{../Simulations/betCostEvol2_/evolDyn18_betCost5} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.9\linewidth]{../Simulations/betCostEvol2_/evolDyn19_betCost5} \end{center}
\end{block}
\end{frame}
...
\includegraphics[width=0.9\linewidth]{../Simulations/initAct_/indVarScatter0_}
\end{block}
\end{frame}
...
\includegraphics[width=0.9\linewidth]{../Simulations/initAct_/indVarScatter1_}
\end{block}
\end{frame}
...
\includegraphics[width=0.9\linewidth]{../Simulations/initAct_/indVarScatter2_}
\end{block}
\end{frame}
