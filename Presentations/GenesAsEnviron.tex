...
\begin{center}\includegraphics[width=0.7\linewidth]{../Images//pavlov} \end{center}
...
\begin{center}\includegraphics[width=0.5\linewidth]{GenesAsEnviron_files/figure-beamer/unnamed-chunk-10-1} \end{center}
